...
//     function createEl() {
//       console.log('hTitleList.value=>', hTitleList.value);
//       return hTitleList.value.map((item) => {
//         const hEl = makeLink(h, item, 'a', 'h1-link')
//         allList.push(item)
//         return hEl
//       })
//     }
//     return function () {
//       return <ul class="sidebar-container">{createEl()}</ul>
//     }
//   },
// })

export default function initSidebar(sidebarQuery, contentQuery) {
  addAllStyle()
